...
data class BillingPaymentResponse(
    ...
    @JvmField @field:Schema(description = "결제 키", example = "y05n91dEvLex6BJGQOVDpgDQ0gDv0QVW4w2zNbgaYRMPoqmD")
    val paymentKey: String,

    @JvmField @field:Schema(description = "주문 ID", example = "a4CWyWY5m89PNh7xJwhk1")
    val orderId: String,

    @JvmField @field:Schema(description = "주문명", example = "프리미엄 구독 결제")
    val orderName: String,

    @JvmField @field:Schema(description = "결제 상태", example = "DONE")
    val status: String,
